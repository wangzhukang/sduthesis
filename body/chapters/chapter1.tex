...
\song{数学}是\hei{人类}对\kai{事物}的\bfsong{抽象结构与模式}进行严格\bfhei{描述}、\bfkai{推导}的一种通用手段，{ \allbfsong 可以应用于现实世界的任何问题，所有的数学对象本质上都是人为定义的。\allbfhei 从这个意义上，数学属于形式科学，而不是自然科学。\allbfkai 不同的数学家和哲学家对数学的确切范围和定义有一系列的看法。}
